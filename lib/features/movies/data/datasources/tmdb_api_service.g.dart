...
class _TmdbApiService implements TmdbApiService {
  ...
  Future<HttpResponse<MovieResponseModel>> getNowPlaying({
    String apiKey = TmdbApiConstants.apiKey,
    ...
    final _options = _setStreamType<HttpResponse<MovieResponseModel>>(
  ...
  Future<HttpResponse<GenreResponseModel>> getGenres({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<GenreResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/genre/movie/list',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GenreResponseModel _value;
    try {
      _value = GenreResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
